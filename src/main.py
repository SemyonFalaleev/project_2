...
from src.handlers.category_handler import router as category_router
from src.handlers.article_nadlers import router as article_router
from src.handlers.auth_handlers import router as auth_router
