...
class AWSClient():
    def __init__(self, url: str, access_key_id: str, secret_access_key: str, bucket_name: str, public: bool = False):
    ...
    def _public_bucket_policy(self) -> str:
        policy = {
            ...
            "Statement": [
                {
                    "Sid": "PublicReadGetObject" if self.public else "PrivateAccessPolicy",
                    "Effect": "Allow",
                    "Principal": "*",
                    "Action": "s3:GetObject",
