...
class ArticleDTOCreate(ArticleBase):
    ...
    @classmethod
    def as_form(
        cls, name: str = Form(), description: str = Form(), category_id: int = Form()
    ) -> "ArticleDTOCreate":
...
from src.dto.category_dto import CategoryDTOGetMin  # noqa: E402
from src.dto.user_dto import UserDTOGetMin  # noqa: E402

ArticleDTOGet.model_rebuild(
    _types_namespace={
        "CategoryDTOGetMin": CategoryDTOGetMin,
